...
kotlin {
    ...
    sourceSets {
        ...
        commonMain.dependencies {
            ...
            implementation("io.github.bay73:generic-ai:0.4.0")
        }
...
android {
    namespace = "com.bay.genericai.ktmdemo"
    compileSdk =
...
compose.desktop {
    application {
        mainClass = "com.bay.aidemo.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "com.bay.genericai.ktmdemo"
